...
<ol class="lang-steps"><li>归并排序：快慢指针找中点断开</li><li>两半分别递归排序</li><li>有序合并（哑头 + tail 逐个摘取）</li></ol>
...
public:
    ListNode* sortList(ListNode* head) {
        ...
        ListNode* slow = head; ListNode* fast = head->next;   // 快慢找中点
...
class Solution:
    def sortList(self, head: ListNode) -> ListNode:
        if not head or not head.next:
            return head
        slow, fast = head, head.next                          # 快慢找中点

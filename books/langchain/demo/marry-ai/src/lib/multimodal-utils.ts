...
/**
 * Converts content blocks from SDK format (mimeType) to API format (mime_type).
 * This is needed because the backend API expects snake_case field names.
 */
export function convertBlocksForAPI(

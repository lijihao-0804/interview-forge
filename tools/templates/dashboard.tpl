...
body{margin:0;min-width:0;overflow-x:hidden;color:var(--text);background:radial-gradient(circle at 12% 0%,color-mix(in srgb,var(--brand) 10%,transparent),transparent 35rem),var(--bg);font:15px/1.65 system-ui,-apple-system,"Segoe UI","Microsoft YaHei",sans-serif}
...
.shell{width:min(100% - 36px,1240px);margin:auto;padding:30px 0 56px}
...
.hm-legend .swatch{width:11px;height:11px;border-radius:2px;background:var(--panel-soft);border:1px solid var(--line)}
.hm-legend .swatch.s1{background:color-mix(in srgb,var(--brand) 26%,var(--panel-soft))}
.hm-legend .swatch.s2{background:color-mix(in srgb,var(--brand) 50%,var(--panel-soft))}
.hm-legend .swatch.s3{background:var(--brand)}
.hm-legend .swatch.s4{background:var(--success)}
...
<main class="shell">
  ...
  <nav class="dashboard-nav" aria-label="学习入口"><a href="library/index.html">学习书架</a><a href="books/hot100/00-总览/01-学习路线.html">学习路线</a><a href="books/hot100/00-总览/02-算法模式地图.html">模式地图</a><a href="books/hot100/00-总览/03-复习清单.html">复习清单</a><a href="books/hot100/04-模板/01-Hot100算法模板.html">算法模板</a><a href="leetcode-connect.html">力扣连接</a><a href="maintenance.html">维护指南</a></nav>
...
<div class="hm-legend" aria-hidden="true"><span>低</span><i class="hm-cell level-1"></i><i class="hm-cell level-2"></i><i class="hm-cell level-3"></i><i class="hm-cell level-4"></i><span>高</span><span style="margin-left:8px">绿色深浅 = 当日力扣提交次数（0 / 1 / 2–4 / 5–9 / 10+）</span></div>
    <div class="hm-legend"><span>少</span><span class="swatch"></span><span class="swatch s1"></span><span class="swatch s2"></span><span class="swatch s3"></span><span class="swatch s4"></span><span>多</span></div>
